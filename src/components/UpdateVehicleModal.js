...
const UpdateVehicleModal = (props) => {
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await updateVehicle(props.vehicle.vehicle_id, updatedVehicle);
  ...
  return (
    <Modal {...props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">Update Vehicle Information</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Row>
          <Col sm={6}>
            <Form onSubmit={handleSubmit}>
              <Form.Group controlId="is_available">
                ...
                <Form.Control
                  ...
                  name="is_available"
                  required
                  defaultValue={props.vehicle.is_available}
                  placeholder=""
                />
              </Form.Group>
